...
class MainWindow(QMainWindow, mainWindow_ui.Ui_MainWindow):
    ...
    def on_runButton_clicked(self):
        ...
        ##
        ##
        # temporarily hardcode for development/debugging on one case initially
        dataPath = "C:/Users/jokling/Documents/WashU_CCIR_MRIData/OriginalDICOM/MF0302_PRE/"
        outNRRDFile = "C:/Users/jokling/Documents/WashU_CCIR_MRIData/OriginalDICOM/MF0302_PRE/newOut.nrrd"
        ##
        ##
        ...
        image, config = self.loadFile(dataPath, outNRRDFile)
        if image is None:
            print("No image")
            return
    ...
    def loadFile(self, dataPath):
        ...
        nrrd.write(constants.abdominalScanFilename, volume, nrrdHeaderDict)
